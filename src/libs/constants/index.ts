  ...
  EDUCATION: {
    ...
    EN: [
      ...
      },
      {
        ...
        description: 'Misiones TIC Pole - Certificate',
        dates: 'Mar 2021 - Jul 2021',
      },
      {
        title: 'Full Stack Web Development - MERN Stack',
        description: 'NUMEN Academy - Certificate',
        dates: 'Mar 2021 - Oct 2021',
      },
      {
        title: 'Scrum Fundamentals Certified',
        description: 'SCRUMstudy - Certificate',
...
export const PROJECTS = {
  ES: [
    ...
    },
    {
      ...
      appLink: 'http://aplicacion.bilan.com.ar/',
      repoLink: '',
